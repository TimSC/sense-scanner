...
public:
    ...
    unsigned int AddSource(QString &fina, QString UidStr, class AvBinMedia *mediaIn);
    void RemoveSource(unsigned int num);
    unsigned int AddAutoAnnot(QString annotUid, QString algUid, class AvBinMedia *mediaIn);
    ...
    void Clear();
    void Load(QString fina, class AvBinMedia *mediaBackIn);
    int Save();
